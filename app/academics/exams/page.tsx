  ...
  return (
    ...
    <div className="relative w-full py-20 md:py-28 flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4">
        ...
        <h1 className="font-heading text-3xl md:text-5xl font-bold text-white mt-3 mb-4">Examinations</h1>
              ...
              {examInfo ? (
                ...
                <>
                  <p className="text-gray-700 mb-4">
                    Siddharth Institute of Management Science conducts examinations to evaluate students'
            ...
            <CardContent className="p-6">
              ...
              <div className="mt-8 p-4 border border-gray-200 rounded-lg">
                ...
                <p className="text-gray-700 mt-2">
                  <span className="font-medium">Email:</span> collagesiddharth7@gmail.com
                  <br />
