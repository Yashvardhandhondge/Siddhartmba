...
export function AdminSidebar() {
  ...
  return (
    <SidebarProvider>
      <Sidebar className="border-r border-navy-100 dark:border-navy-400 h-screen" variant="sidebar" collapsible="none">
        <SidebarHeader className="border-b border-navy-100 dark:border-navy-400 py-3">
          <div className="flex items-center px-4">
            <div className="flex items-center gap-2">
              <div className="h-8 w-8 rounded-full bg-navy-500 flex items-center justify-center text-gold-400 font-bold text-sm">
                S
              </div>
              <span className="font-bold text-lg text-navy-500 dark:text-white">SIMS Admin</span>
            </div>
          </div>
        </SidebarHeader>
          ...
          <SidebarMenu>
            ...
            <SidebarMenuItem>
              <SidebarMenuButton onClick={() => toggleSubmenu("academics")} className="justify-between">
                ...
                <ChevronDown className={cn("h-4 w-4 transition-transform", openSubmenus.academics ? "rotate-180" : "")} />
              </SidebarMenuButton>
                ...
                <SidebarMenuSub>
                  <SidebarMenuSubItem>
                    <SidebarMenuSubButton asChild isActive={pathname === "/admin/dashboard/academics/admissions"}>
                      <Link href="/admin/dashboard/academics/admissions">MBA Admissions</Link>
                    </SidebarMenuSubButton>
                  </SidebarMenuSubItem>
                  <SidebarMenuSubItem>
            ...
            <SidebarMenuItem>
              <SidebarMenuButton asChild isActive={pathname.includes("/admin/dashboard/messages")}>
        ...
        <SidebarFooter className="border-t border-navy-100 dark:border-navy-400 p-4">
